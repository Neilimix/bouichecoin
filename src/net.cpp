...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bouichecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"node1.discovereat.ovh", "147.135.248.168"},
    {"node2.discovereat.ovh", "147.135.248.169"},
    {"node3.discovereat.ovh", "147.135.248.170"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"bouichecointools.com", "testnet-seed.bouichecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bouichecoin is probably already running."), addrBind.ToString().c_str());
        else
